...
public class CheckoutPage extends _BasePage {
	...
	private WebElement billAdrSaveBtn;

	// Choix de la méthode de livraison
	/**
	 * Bouton validation adresse facturation
	 */
	@FindBy(css = ".sel-shipping-save")
	private WebElement shipAdrSaveBtn;
	/**
...
//		}
	...
	public void fillShippingAddress()
			throws PageObjectException {
		try{ 
			fluentWait(shippingInput);
			shippingInput.click();
			shippingInput.submit();
		}catch(Exception e){
