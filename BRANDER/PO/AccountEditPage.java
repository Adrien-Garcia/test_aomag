 ...
 * @since 2015-04-25
 */
public class AccountEditPage extends _BasePage {
	/**
	 * Logger pour cette classe
	 */
	private static Log log = LogFactory.getLog(AccountEditPage.class);

	// Elements du DOM
	/**
	 * Body de la page
	 */
	@FindBy(css = "body.customer-account-edit")
	 ...
	 */
	public AccountEditPage(RemoteWebDriver _driver) throws PageObjectException {
		super(_driver);
	 ...
	 * @throws PageObjectException
	 */
	public AccountPage editAccountInfos(String firstname, String lastname, String email) throws PageObjectException {
//		try {
...
//		}
	 ...
	 * @throws PageObjectException
	 */
	public AccountPage changePassword(String currentPass, String newPass) throws PageObjectException {
		try {
			passCheckBox.click();
			fluentWait(curentPassInput);
