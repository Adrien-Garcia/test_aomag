 ...
 * @since 2015-04-25
 */
public class WishlistPage extends _BasePage {
	/**
	 * Logger pour cette classe
	 */
	private static Log log = LogFactory.getLog(WishlistPage.class);
	 ...
	 */
	public WishlistPage(RemoteWebDriver _driver) throws PageObjectException {
		super(_driver);
	...
	public void emptyWishlist() throws PageObjectException {
		try {
			...
			throw new PageObjectException(this.driver,"Il y a eu un problème lors du vidage de la wishlist", e);
		}
	}
