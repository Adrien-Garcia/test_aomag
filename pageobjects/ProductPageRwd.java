 ...
 * @since 2015-04-25
 */
public class ProductPageRwd extends _BasePageRwd {
	/**
	 * Logger pour cette classe
	 */
	private static Log log = LogFactory.getLog(ProductPageRwd.class);
	...
	/**
	 * Popup de confirmation à l'ajout du produit au panier
	 */
	 ...
	 */
	@FindBy(css = ".ratings a:first-of-type")
	 ...
	 */
	public ProductPageRwd(RemoteWebDriver _driver) throws PageObjectException {
		super(_driver);
	 ...
	 * @throws PageObjectException
	 */
	public ShoppingCartPageRwd addProductToCart(int quantity) throws PageObjectException {
		try {
			...
			if (isProductInStock() == true)
				...
				throw new PageObjectException("Le produit est épuisé");
			implicitWait(2);
			...
			throw new PageObjectException("Ajout du produit au panier échoué" + e);
		}
	}
	 ...
	 * @throws PageObjectException
	 */
	public WishlistPageRwd addProductToWishlist() throws PageObjectException {
		try {
			addToWishlistLink.click();
			return new WishlistPageRwd(driver);
		} catch (Exception e) {
			throw new PageObjectException("Ajout du produit à la liste d'envie échoué" + e);
		}
	}
	...
	public void addProductToComparator() throws PageObjectException {
		try {
			...
			throw new PageObjectException("L'ajout au comparteur ne s'est pas effectué", e);
		}
	}
	...
	public void addReviewToProduct(String review, String reviewTitle, String nickname) throws PageObjectException {
		try {
			...
			throw new PageObjectException("L'envoi du commentaire a echoué", e);
		}
	}
