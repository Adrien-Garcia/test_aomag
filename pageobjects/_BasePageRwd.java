...
public class _BasePageRwd {
	 ...
	 */
	public SearchResultPageRwd searchForResults(String search) {
		searchInput.clear();
		searchInput.sendKeys(search);
		searchInput.submit();
		return new SearchResultPageRwd(driver);
	}
	...
	public AccountPageRwd goToAccountPage() throws PageObjectException {
		...
		if (isUserLoggedIn() == true) {
			...
			throw new PageObjectException("L'utilisateur n'est pas connecté et ne peut pas accéder à son compte");
		}
	}
	...
	public String getH1Title() throws PageObjectException {
		try {
			...
			throw new PageObjectException("La page ne contient pas de titre H1, revoir le test", e);
		}
	}
