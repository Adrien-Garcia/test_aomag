 ...
 * @since 2015-04-27
 */
public class SearchResultPageRwd extends _BasePageRwd {
	/**
	 * Logger pour cette classe
	 */
	private static Log log = LogFactory.getLog(SearchResultPageRwd.class);
	 ...
	 */
	public SearchResultPageRwd(RemoteWebDriver _driver) {
		super(_driver);
